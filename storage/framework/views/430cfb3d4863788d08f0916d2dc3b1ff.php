...
<?php endif; ?>
    ...
    <!-- Email Address -->
        <div>
            <label class="block font-medium text-sm text-gray-700" for="email"><?php echo e(__('Email/Username/Mobile No.')); ?> <span style="color: darkred">*</span></label>
...
<?php endif; ?>
        ...
        <!-- Password -->
        <div class="mt-4">
            <label class="block font-medium text-sm text-gray-700" for="password"><?php echo e(__('Password')); ?> <span style="color: darkred">*</span>
                <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
...
<?php endif; ?>
<?php /**PATH D:\PHP-8.2.4\htdocs\test-project\resources\views/auth/login.blade.php ENDPATH**/ ?>