...
<script>
    ...
    function insidePreloaderToggle(condition){
        if(condition){
            $("#inside-preloader").fadeIn();
            $('body').css('overflow','hidden');
        }else{
            $("#inside-preloader").fadeOut();
            $('body').css('overflow','initial');
        }
    }
        ...
        return [
            {
                ...
                "className": "btn btn-info bg-gradient-info btn-sm"
            },{
                "extend": "csv",
...
<?php /**PATH D:\PHP-8.2.4\htdocs\test-project\resources\views/layouts/partial/__scripts.blade.php ENDPATH**/ ?>